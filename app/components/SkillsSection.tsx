...
const categories = [
  ...
  },
  {
    ...
    skills: [
      "Next.js", "React", "TypeScript", "Flutter", "Tailwind CSS", "MUI", "HTML/CSS",
    ],
  },
  {
    title: "Backend",
    ...
    skills: [
      ...
      "AWS EC2", "Docker", "Vercel", "Digital Ocean",
    ],
  },
  {
    ...
    skills: [
      "Claude Opus (Anthropic)", "GitHub Copilot",
    ],
  },
  {
    title: "Tools",
    ...
    skills: [
      "Postman", "Swagger", "ClickUp", "DB Diagrams", "Git", "Figma",
    ],
  },
];
    ...
    <section id="skills" className="relative">
      ...
      <div className="section-container" ref={ref}>
        <div className="text-center mb-12">
          ...
          >
            From low-level Rust programs on Solana to polished Next.js frontends — a full-spectrum engineering stack.
          </p>
        </div>
